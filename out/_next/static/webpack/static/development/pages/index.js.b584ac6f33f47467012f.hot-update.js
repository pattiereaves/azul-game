  ...
  function Index() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "hydrateStateWithLocalStorage", function () {
      ...
      _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(state).forEach(function (key) {
        if (!local_storage__WEBPACK_IMPORTED_MODULE_9___default()(key)) {
          return;
        }

        var value = local_storage__WEBPACK_IMPORTED_MODULE_9___default.a.get(key); // try {

        value = JSON.parse(value);
        debugger;

        _this.setState(Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])({}, key, value)); // } catch (e) {
        // Handle empty string
...
//# sourceMappingURL=index.js.b584ac6f33f47467012f.hot-update.js.map